...
<div class="row">
  ...
  <div class="col-md-2 bg-secondary p-0">
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-center text-light ">
      <li class="nav-item mb-2 bg-info"><h3>Delivery Brands</h3></li>
      <li class="nav-item mb-2"><a href=""></a>Brand 1</li>
      <li class="nav-item mb-2"><a href=""></a>Brand 1</li>
      <li class="nav-item mb-2"><a href=""></a>Brand 1</li>
      <li class="nav-item mb-2"><a href=""></a>Brand 1</li>
      <li class="nav-item mb-2"><a href=""></a>Brand 1</li>
    ...
    <!-- categories  -->
    <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-center text-light ">
      <li class="nav-item mb-2 bg-info"><h3>Categories</h3></li>
      <li class="nav-item mb-2"><a href=""></a>Category 1</li>
      <li class="nav-item mb-2"><a href=""></a>Category 1</li>
      <li class="nav-item mb-2"><a href=""></a>Category 1</li>
      <li class="nav-item mb-2"><a href=""></a>Category 1</li>
      <li class="nav-item mb-2"><a href=""></a>Category 1</li>
